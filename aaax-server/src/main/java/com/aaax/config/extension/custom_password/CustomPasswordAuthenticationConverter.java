...
public class CustomPasswordAuthenticationConverter implements AuthenticationConverter {
    ...
    public Authentication convert(HttpServletRequest request) {
        ...
        if (!GrantTypeExtension.CUSTOM_PASSWORD_GRANT.getKey().equals(grantType)) {
            return null;
        }
        ...
        if (!StringUtils.hasText(username) ||
            ...
            throw new OAuth2AuthenticationException(OAuth2ErrorCodes.INVALID_REQUEST.concat(":").concat(GrantTypeExtension.CUSTOM_PASSWORD_GRANT.getKey()));
        }
        ...
        return new CustomPasswordAuthenticationToken(username, credentials, clientPrincipal, additionalParameters);
    }
