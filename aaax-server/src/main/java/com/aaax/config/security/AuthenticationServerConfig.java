...
import com.aaax.config.extension.CustomOAuth2RefreshTokenGenerator;
import com.aaax.config.extension.CustomOAuth2TokenGenerator;
import com.aaax.config.extension.GrantTypeExtension;
import com.aaax.config.extension.custom_password.CustomPasswordAuthenticationConverter;
import com.aaax.config.extension.custom_password.CustomPasswordAuthenticationProvider;
import com.aaax.config.extension.custom_password_e.CustomPasswordEncryptedAuthenticationConverter;
import com.aaax.config.extension.custom_password_e.CustomPasswordEncryptedAuthenticationProvider;
import com.aaax.config.extension.custom_refresh_token.CustomRefreshTokenAuthenticationConverter;
import com.aaax.config.extension.custom_refresh_token.CustomRefreshTokenAuthenticationProvider;
import com.aaax.config.extension.customcode.CustomCodeGrantAuthenticationConverter;
import com.aaax.config.extension.customcode.CustomCodeGrantAuthenticationProvider;
import com.aaax.config.extension.ext_password.ExtPasswordAuthenticationConverter;
import com.aaax.config.extension.ext_password.ExtPasswordAuthenticationProvider;
import com.aaax.config.extension.social_auth.ThirdPartyAuthenticationConverter;
import com.aaax.config.extension.social_auth.ThirdPartyAuthenticationProvider;
import com.aaax.config.security.jwt.ClientCredentialsJwt;
import com.aaax.config.security.jwt.Jwt;
import com.aaax.exception.GlobalExceptionHandler;
