...
import com.aaax.config.extension.custom_password_e.CustomPasswordEncryptedAuthenticationToken;
import com.aaax.config.extension.custom_refresh_token.CustomRefreshTokenAuthenticationProvider;
import com.aaax.config.extension.custom_refresh_token.CustomRefreshTokenAuthenticationToken;
import com.aaax.config.extension.customcode.CustomCodeGrantAuthenticationProvider;
import com.aaax.config.extension.customcode.CustomCodeGrantAuthenticationToken;
import com.aaax.config.extension.ext_password.ExtPasswordAuthenticationProvider;
import com.aaax.config.extension.ext_password.ExtPasswordAuthenticationToken;
import com.aaax.config.extension.qrcode.QrCodeGrantAuthenticationProvider;
import com.aaax.config.extension.qrcode.QrCodeGrantAuthenticationToken;
import com.aaax.config.extension.sms.SmsGrantAuthenticationProvider;
import com.aaax.config.extension.sms.SmsGrantAuthenticationToken;
import com.aaax.config.extension.social_auth.ThirdPartyAuthenticationProvider;
import com.aaax.config.extension.social_auth.ThirdPartyAuthenticationToken;
