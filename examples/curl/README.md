...
Scripts (running AS on 8081; login/me need profile `local` + seed, or your own client/user):
...
```bash
# profile `local` seed — grant_type=custom-password-grant, field credentials=
./examples/curl/login-me.sh
