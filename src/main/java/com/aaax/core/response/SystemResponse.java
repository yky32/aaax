...
/**
 * Copied from qs app-core {@code com.quinsic.core.response.SystemResponse}.
 */
public interface SystemResponse {
    ...
    Response SYS9998 =
            new Response("SYS9998", "Fail. in [system error]. plz check log in kibana/loki.", HttpStatus.INTERNAL_SERVER_ERROR);
