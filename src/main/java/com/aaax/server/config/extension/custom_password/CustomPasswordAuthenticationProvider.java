...
@Slf4j
public class CustomPasswordAuthenticationProvider extends BaseAuthenticationProvider implements AuthenticationProvider {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        String username = ((CustomPasswordAuthenticationToken) authentication).getUsername();
        String credentials = ((CustomPasswordAuthenticationToken) authentication).getCredentials();
        ...
        if (existedOAuth2Authorization != null) {
            ...
            super.post_login_event(userId, GrantTypeExtension.CUSTOM_PASSWORD_GRANT.getKey(), startTrafficDt,
        ...
        Authentication authenticate = new CustomPasswordAuthenticationToken(username, credentials, authentication, null);
        ...
        super.post_login_event(userId, GrantTypeExtension.CUSTOM_PASSWORD_GRANT.getKey(), startTrafficDt, JSONUtil.convertFromObject(authentication, Map.class), token);
        return token;
    }
