package com.aaax.server.listener.log;
...
import static com.aaax.core.kafka.enu.KafkaTopic.USER_LOG;
...
public class LogsListener extends BaseListener {
    ...
    @KafkaListener(
            topics = USER_LOG, groupId = USER_LOG + "-group",
    ...
    @Bean
    public NewTopic USER_LOG() {
        return new NewTopic(USER_LOG, 1, (short) 1);
    }
}
