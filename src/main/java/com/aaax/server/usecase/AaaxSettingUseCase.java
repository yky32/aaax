...
import com.aaax.server.exception.response.AaaxSettingErrorResponse;
...
@Slf4j
public class AaaxSettingUseCase {
    ...
    public String getBasicAuthorization(String id) {
        ...
        if (_registeredClient == null) {
            throw new BizException(AaaxSettingErrorResponse.AAS0001, "id =>".concat(id));
        }
