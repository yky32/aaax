...
class CustomCodeGrantAuthenticationProviderHappyPathTest {
    ...
    void authenticate_shouldRejectUnimplementedGrant() {
        var provider = new CustomCodeGrantAuthenticationProvider(authorizationService, tokenGenerator, authenticationManager);
        ...
        CustomCodeGrantAuthenticationToken auth =
                new CustomCodeGrantAuthenticationToken("123", clientPrincipal, null);
