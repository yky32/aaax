...
class AaaxSettingUseCaseTest {

    @Mock private PasswordEncoder passwordEncoder;
    @Mock private RegisteredClientRepository registeredClientRepository;

    @InjectMocks
    private AaaxSettingUseCase aaaxSettingUseCase;

    @BeforeEach
    void setUp() {
        ReflectionTestUtils.setField(aaaxSettingUseCase, "serverTokenExpiryTime", 3600);
        ReflectionTestUtils.setField(aaaxSettingUseCase, "registeredClientSecret", "secret");
    }
    ...
    void createRegisteredClient_shouldReturnExisting() {
        ...
        assertSame(existing, aaaxSettingUseCase.createRegisteredClient(
    ...
    void createRegisteredClient_shouldSaveNew() {
        ...
        RegisteredClient result = aaaxSettingUseCase.createRegisteredClient(
    ...
    void create_shouldReturnExisting() {
        ...
        ClientResponseDto result = aaaxSettingUseCase.create(
                CreateRegisteredClientRequestDto.builder().clientId("c1").tokenExpiryTime(60).build());
    ...
    void search_shouldMap() {
        ...
        ClientResponseDto result = aaaxSettingUseCase.search("id-9");
    ...
    void updateSecret_shouldThrowWhenMissing() {
        ...
        assertThrows(BizException.class, () -> aaaxSettingUseCase.updateSecret("missing"));
    }
    ...
    void updateSecret_shouldRotate() {
        ...
        ClientResponseDto result = aaaxSettingUseCase.updateSecret("id-1");
    ...
    void getBasicAuthorization_shouldEncode() {
        ...
        String encoded = aaaxSettingUseCase.getBasicAuthorization("id-1");
    ...
    void getBasicAuthorization_shouldThrowWhenMissing() {
        ...
        assertThrows(BizException.class, () -> aaaxSettingUseCase.getBasicAuthorization("x"));
    }
}
