...
import com.aaax.entity.enu.UserPreferenceType;
...
import com.aaax.repository.UserPreferenceRepository;
...
class UserPreferenceAndProfileUseCaseTest {
    ...
    void doCreateDefault_shouldPersist() {
        ...
        when(uaaService.getById(8L)).thenReturn(
                com.aaax.entity.po.user.User.builder().id(8L).username("user@test.com").build());
    ...
    void updateUserProfileMgt_shouldDelegate() {
        when(uaaService.getById("3")).thenReturn(
                com.aaax.entity.po.user.User.builder().id(3L).username("u@test.com").build());
        UserProfile profile = UserProfile.builder()
                .id(2L).userId(3L).alias("nick")
